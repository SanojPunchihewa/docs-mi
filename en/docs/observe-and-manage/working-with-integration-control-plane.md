    ...
    **How the MI node advertises its management API**
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <b>Optional</b>. Port of the WSO2 Integrator: MI management endpoint, set alongside <code>management_hostname</code>. If omitted, the advertised URL carries no port (<code>https://&lt;management_hostname&gt;/management/</code>), which suits an Ingress or reverse proxy on the default HTTPS port.
            </td>
        </tr>
    </table> 
